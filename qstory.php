...
$x_redirect_uri  = 'https://aiknowledgecms.exbridge.jp/qstory.php';

define('OLLAMA_API', 'https://exbridge.ddns.net/api/generate');
define('OLLAMA_MODEL', 'gemma4:e4b'); 
/* define('OLLAMA_MODEL', 'qwen3.5:27b'); */
...
<header>
    <div class="logo">Q<span>Story</span></div>
    <div class="userbar">
        <?php if ($logged_in): ?>
